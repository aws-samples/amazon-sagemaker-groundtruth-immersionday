...
class SimpleActiveLearning:
    ...
    def autoannotate(self, predictions, sources,byom):
        """
        ...
        for prediction in predictions:
            ...
            if byom=='true':
                AUTOANNOTATION_THRESHOLD=BYOM_AUTOANNOTATION_THRESHOLD
            else:
                AUTOANNOTATION_THRESHOLD=BLAZINGTEXT_AUTOANNOTATION_THRESHOLD
