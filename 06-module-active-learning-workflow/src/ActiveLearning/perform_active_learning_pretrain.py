...
from ActiveLearning.helper_pretrain  import SimpleActiveLearning
...
def collect_inference_outputs(inference_output_uri):
    ...
    """
    sagemaker_output_file = "data.jsonl.out"
...
def lambda_handler(event, context):
    ...
    # Select maximum of 50 records of the input total for next round of manual labeling.
    max_selections = input_total // 200
