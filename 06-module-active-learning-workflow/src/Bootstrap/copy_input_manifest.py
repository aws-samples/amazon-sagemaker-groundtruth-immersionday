...
def lambda_handler(event, context):
    ...
    #Check whether you want to do Pretrain Model training
    if os.environ['pretrain_model'] == 'true' :
        pretrain_model='true'
    else :
        pretrain_model='false'
    
    if os.environ['byom'] == 'true' :
        byom='true'
    else :
        byom='false'
    ...
    return {
        ...
        "PretrainedModel":pretrain_model,
        "BringYourOwnModel":byom
    }
